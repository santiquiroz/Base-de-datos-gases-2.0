 ...
 */
public class InfoClienteEdit extends View implements IView{
    
    DataBase db = new DataBase();
    String usuario,telefono,nombre,fecha_registro,puntos,empresarial,comun,id_municipio;
    
    public InfoClienteEdit(ArrayList datoscliente) {
        ...
        if(comun.equals("1")){
            jComboBox1.setSelectedItem("comun");
        }
        else{
            jComboBox1.setSelectedItem("empresarial");
        }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Actualizar y cerrar");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        df.delete2("DELETE FROM cliente WHERE telefono = '"+telefono+"'");
        this.dispose();
