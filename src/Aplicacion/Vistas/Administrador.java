...
public class Administrador extends View implements IView{
    ...
    private void initComponents() {
        ...
        jLabel117.setText("Tipo producto");
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel20Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField90, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jButton26.setText("Registrar producto");
        ...
        jComboBox13.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Liquido", "Envase", "Extintor", "Soldadura", "Gas industrial", "Otro" }));
        jComboBox13.setToolTipText("");

        jLabel103.setText("Clientela");

        jComboBox14.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Empresarial", "Municipio" }));
        ...
        jTextField81.setText("TODOS LOS CLIENTES EMPRESARIALES NUEVOS");
        ...
        jButton27.setText("Registrar color");
        ...
        jLabel107.setText("Clientela");

        jLabel108.setText("Codigo");

        jTextField84.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextField84KeyPressed(evt);
            }
        });

        jComboBox15.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Empresarial", "Municipio" }));
        ...
        jLabel109.setText("Poseedor");

        jTextField85.setText("TODOS LOS CLIENTES EMPRESARIALES NUEVOS");
                            ...
                            .addGroup(jPanel15Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jTextField84, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jComboBox15, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane4.addTab("Registrar Producto Empresarial (por defecto)", jPanel15);
        ...
        jLabel110.setText("INGRESE LOS DATOS CONOCIDOS");

        jLabel111.setText("Codigo");
        ...
        jComboBox16.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Liquido", "Envase", "Extintor", "Soldadura", "Gas industrial", "Otro", "Desconocido" }));
        ...
        jLabel115.setText("Clientela");

        jComboBox17.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Empresarial", "Comun" }));
        ...
        jLabel116.setText("Telefono cliente");

        jTextField89.setText("EMPRESARIALES NUEVOS");
        ...
        jPanel21Layout.setHorizontalGroup(
                        ...
                        .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jTextField86, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addComponent(jComboBox17, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jTextField89, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(220, 220, 220))
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addGap(92, 92, 92)
                        .addComponent(jLabel110, javax.swing.GroupLayout.PREFERRED_SIZE, 444, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addGap(70, 70, 70)
        ...
        jTabbedPane4.addTab("Buscar Producto Empresarial (por defecto)", jPanel21);
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        String tipo_producto = jTextField90.getText();
        if ((!jRadioButton38.isSelected())||((jRadioButton38.isSelected())&&(jCheckBox3.isSelected()==false) && (tipo_producto.equals("")))) {
...
//boolean b1 = IO.textfield_requerido(jTextField2, jTextField3);
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        RegistrarColorePredeterminado();
    }//GEN-LAST:event_jButton27ActionPerformed

    private void jTextField84KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField84KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField84KeyPressed
    ...
    private void jButton28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton28ActionPerformed
            buscarProductoEmpresarialDefecto();
    ...
    private void registrarProductoeDefecto() {
        db= new DataBase();
        boolean b1 = IO.textfield_requerido(jTextField24, jTextField80, jTextField79 );
        String codigoProducto=jTextField24.getText();
        String nombreProducto=jTextField80.getText();
        String pesoProducto=jTextField79.getText();
        String tipoProducto=(String)jComboBox13.getSelectedItem();
        
        
        if(b1){
            db= new DataBase();
            db.excecuteQuery("SELECT * FROM productoepredeterminado WHERE(codigo='"+codigoProducto+"')");
            if(db.isEmpty()){
                db = new DataBase();
                db.insertar3("INSERT INTO productoepredeterminado(codigo,nombre,peso,tipo) VALUES( '"+codigoProducto+"', '"+nombreProducto+"', '"+pesoProducto+"', '"+tipoProducto+"')");
            }
            else{
                JOptionPane.showMessageDialog(null, "El producto ya esta registrado");
            }
    ...
    private void RegistrarColorePredeterminado() {
        db= new DataBase();
        boolean b1 = IO.textfield_requerido(jTextField84, jTextField82,jTextField83);
        String codigoProducto=jTextField84.getText();
        String colorProducto=jTextField82.getText();
        String precioProducto=jTextField83.getText();   
        
        if(b1){
            db= new DataBase();
            db.excecuteQuery("SELECT * FROM colorepredeterminado WHERE(color='"+colorProducto+"' AND id_productoe = '"+codigoProducto+"')");
            if(db.isEmpty()){
                db = new DataBase();
                db.insertar3("INSERT INTO colorepredeterminado (color,precio,disponible,id_productoe_codigo) VALUES('"+colorProducto+"','"+precioProducto+"','1','"+codigoProducto+"')");
            }
            else{
                JOptionPane.showMessageDialog(null, "El codigo ya esta registrado");
            }
    ...
    private void buscarProductoEmpresarialDefecto() {
        this.prod1.removeAll();
        ...
        db=new DataBase();
        ArrayList datos;
        String tipoS=(String)jComboBox16.getSelectedItem();
        JInternalFrame frameprod1 = new JInternalFrame("productos");
        
        prod1.add( frameprod1 );
        if(tipoS.equals("Desconocido")){
            tipoS="";
        }
        
        datos =db.excecuteQuery("SELECT codigo,nombre,peso,tipo FROM productoepredeterminado WHERE codigo LIKE '"+jTextField86.getText()+"%' AND nombre LIKE '"+jTextField87.getText()+"%' AND peso LIKE '"+jTextField88.getText()+"%' AND tipo LIKE '"+tipoS+"%'");
         
        if(db.isEmpty()){
            SimpleTableDemo consultaProductos = new SimpleTableDemo(cabecera,new Object[0][4], "productos", "InfoProducto",this,"soloIdentificador");
            
            SimpleTableDemo newContentPane = new SimpleTableDemo();
            newContentPane.setOpaque(true); 
            frameprod1.setContentPane(consultaProductos);
            frameprod1.setBorder(null);
            ((javax.swing.plaf.basic.BasicInternalFrameUI)frameprod1.getUI()).setNorthPane(null);
            frameprod1.setVisible(true);
            prod1.repaint();
            prod1.setVisible(true);
        
                try {
                    frameprod1.setMaximum(true);
                } catch (PropertyVetoException ex) {
                    Logger.getLogger(InfoPedido.class.getName()).log(Level.SEVERE, null, ex);
                }
        }
        else{
            SimpleTableDemo consultaProductos = new SimpleTableDemo(cabecera,new ConvertidorAMatriz(datos,4).result(), "productos", "InfoProducto",this,"soloIdentificador");
            SimpleTableDemo newContentPane = new SimpleTableDemo();
            newContentPane.setOpaque(true); 
            frameprod1.setContentPane(consultaProductos);
            frameprod1.setBorder(null);
